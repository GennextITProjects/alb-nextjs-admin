...
// const CustomerLoginSheetMain: React.FC<CustomerLoginSheetProps> = ({ 
//   isOpen, 
//   onClose,
//   onLoginSuccess 
// }) => {
...
//   // ✅ FIXED: Better state management for FCM
...
//   // ✅ FIXED: Proper FCM initialization with better error handling
//   useEffect(() => {
...
//         const existingToken = localStorage.getItem('fcm_token') || 'FCM initialization';
//         if (existingToken) {
...
//         // Step 2: Request new token (with retry logic from firebase.ts)
...
//         // Step 3: Setup foreground message listener
...
//         setIsFcmReady(true); // Mark as ready to not block login
//       }
//     };
...
//   useEffect(() => {
//     if (customerOtp.length === 4 && !isLoading) {
//       handleSubmitOtp();
//     }
//   }, [customerOtp]);
...
//   // ✅ CRITICAL FIX: Proper token handling in OTP verification
...
//         // ✅ CRITICAL: Get fresh FCM token with fallback logic
...
//           tokenToSend = localStorage.getItem('fcm_token') || 'FCM initialization';
//         }
        
//         // Fallback 2: Try to generate new token
//         if (!tokenToSend) {
...
//         console.log('📤 Sending verification with FCM token:', tokenToSend ? '✅ Present' : '❌ Missing');
...
// export default CustomerLoginSheetMain;