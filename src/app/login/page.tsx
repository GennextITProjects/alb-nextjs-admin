      ...
      <div className="bg-white rounded-3xl shadow-lg p-8 w-full max-w-md">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-red-500 hover:bg-red-600 disabled:bg-gray-400 text-white font-medium text-lg py-3 rounded-lg transition duration-200 disabled:cursor-not-allowed"
          >
